...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  ...
  config.vm.define :chefs do |server|
    ...
    server.vm.provision "shell", inline: "DEBIAN_FRONTEND=noninteractive apt-get install -y --force-yes chef-server-core"
  ...
  config.vm.define :chefd do |dev|
    ...
    dev.vm.provision "shell", inline: "DEBIAN_FRONTEND=noninteractive apt-get install -y --force-yes chefdk"
